...
数量は**サンプル出荷指示を処理し終えた後の状態**。
出荷済(30)・引当済(20)の伝票の明細分は、すでに在庫から引かれているものとして設定している。

| 商品 | WH01 | WH02 | WH03 | 備考 |
|---|---|---|---|---|
| ITM-1001 | 110 | 45 | ― | WH01 は 120 − 10(SH-20260901-001 / 出荷済) |
| ITM-1002 | 18 ※ | 55 | ― | WH02 は 60 − 5(SH-20260910-001 / 引当済) |
| ITM-1003 | 230 | ― | 12 ※ | SH-20260915-001 は登録済のため未引当 |
| ITM-2001 | 800 | 420 | ― | WH01 は 850 − 50(SH-20260901-001 / 出荷済) |
| ITM-2002 | 95 ※ | ― | ― | ― |
| ITM-3001 | ― | 1,100 | ― | 1,200 − 100(SH-20260910-001 / 引当済) |
| ITM-3002 | 8 ※ | ― | 22 | ― |
| ITM-4001 | ― | 40 | ― | ― |
| ITM-4002 | ― | 35 ※ | ― | ― |
| ITM-5001 | 70 ※ | ― | ― | ― |
...
> 上記の出荷指示と `stock` の数量は整合が取れている。
> 出荷済・引当済の明細分は在庫から引かれた状態、登録済(SH-20260915-001)の分は未引当の状態。
> そのため、SH-20260915-001 を画面から引き当てると ITM-1003@WH01 が 230 → 218 になる。
